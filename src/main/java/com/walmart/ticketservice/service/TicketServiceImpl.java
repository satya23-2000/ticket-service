...
public class TicketServiceImpl implements TicketService {
	...
	private synchronized SeatHold holdSeats(int numSeats, String customerEmail) {
		...
		for (Seats seat : subList) {
			...
			// Set Hold Time
			seat.setUpdated(new Timestamp(System.currentTimeMillis()));
			seat.setHolduntil(new Timestamp(System.currentTimeMillis() + Constants.HOLD_TIME));
		...
		// set current time
		seatHold.setReservedTime(new SimpleDateFormat("yyyy.MM.dd.HH.mm.ss", Locale.US).format(new Date()));
