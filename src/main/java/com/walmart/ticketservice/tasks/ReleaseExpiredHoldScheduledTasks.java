 ...
 * 
 * This job runs every 30 secs and release or update the records 
 * if the HoldUntil time is in past. 
 * 
 */
...
public class ReleaseExpiredHoldScheduledTasks {
    ...
    public void reportCurrentTime() {
    	...
    	List<Seats> seats = venueSeatingRepository.findAllByStatusAndHolduntilIsNotNull("H");
